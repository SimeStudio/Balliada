 ...
 * AppStateClient objects are also wanted, call the GoogleBaseGameActivity(int)
 * constructor and specify the requested clients. For example, to request
 * PlusClient and GamesClient, use GoogleBaseGameActivity(CLIENT_GAMES | CLIENT_PLUS).
 * To request all available clients, use GoogleBaseGameActivity(CLIENT_ALL).
 ...
 */
public abstract class GoogleBaseGameActivity extends SimpleBaseGameActivity implements
    ...
    private final static String TAG = "GoogleBaseGameActivity";
    protected boolean mDebugLog = false;

    /** Constructs a GoogleBaseGameActivity with default client (GamesClient). */
    protected GoogleBaseGameActivity() {
        super();
    }

    /**
     * Constructs a GoogleBaseGameActivity with the requested clients.
    ...
    protected void enableDebugLog(boolean enabled, String tag) {
        Log.w(TAG, "GoogleBaseGameActivity.enabledDebugLog(bool,String) is " +
